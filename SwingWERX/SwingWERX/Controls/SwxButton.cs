...
namespace SwingWERX.Controls
{
        ...
        : Button
    {
        ...
        private String _ButtonText = "swxButton";
        [PropertyTab("ButtonText")]
        [DisplayName("ButtonText")]
        [Description("The text to be displayed by the button.")]
        [Category("Appearance")]
        [Browsable(true)]
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.DrawString(ButtonText, base.Font, brush, rect, sFormat);
